...
@Component({
  selector: 'app-evoucher-used-info',
  templateUrl: './evoucher-used-info.component.html',
  styleUrls: ['./evoucher-used-info.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class EvoucherUsedInfoComponent extends MangoHitBaseSearch implements OnInit {

  moduleName = 'evoucher-used-info';
  ...
  constructor(protected formBuilder: FormBuilder,
    ...
    this.columns.push(
      ...
      {
        columnDef: 'used-date', header: 'used-date',
        title: (e: any) => `${e.used_date ? e.used_date : ''}`,
        cell: (e: any) => `${e.used_date ? e.used_date : ''}`,
        className: '',
      },
