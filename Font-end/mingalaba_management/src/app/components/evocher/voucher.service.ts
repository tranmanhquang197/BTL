...
export class VoucherService {
    ...
    GET_CUSTOMER = gql`
      query getCustomers($is_user: Int!,$page_number: Int!,$page_size: Int!,$search_code:String) {
        getCustomers(is_user: $is_user, page_number: $page_number, page_size: $page_size,search_code:$search_code) {
                  content{
                    id
                    name
                    address
    ...
    // GET_REDEEM = gql`
    //   subscription {
    //      redeemVoucherSuccess(user_id:15) {
    //           voucher {
    //             title
    //             type {
    //               name
    ...
    query getVoucherInfoByVoucherId($voucherId: Int!,$searchCode: String,$page_number: Int!,$page_size: Int!) {
      getVoucherInfoByVoucherId(voucher_id:$voucherId,searchCode: $searchCode,is_used: true, page_number: $page_number, page_size: $page_size) {
        content {
          id,
          used_date
          user {
